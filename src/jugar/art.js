...
// Esta app vive en /jugar/ y el arte en la raíz del sitio, así que la ruta
// sube un nivel. Funciona igual en dev (/jugar/ → /tokens/) que publicado
// (/papertokens/jugar/ → /papertokens/tokens/).
const BASE = '../';
